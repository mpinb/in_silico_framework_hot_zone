...
##############################################
HAY_BAP_DEFINITIONS = {
            'Spikecount':     ("Amount of spikes",              1.0,    0.01),
            'AP_height':      ("AP height",                     25.0,   5.0),
            'AP_width':       ("AP width",                      2.0,    0.5),
            'BPAPatt2':       ("bAP attenuation between \
                               soma and recSite 1",             45.0,   10.0),
            'BPAPatt3':       ("bAP attenuation between \
                                soma and recSite 2",            36.0,   9.3300000000000001),
            'AHP_depth_abs':  ("After-hyperpolarization depth", -65.0,  4.0)
}
...
HAY_BAC_DEFINITIONS = {
            ...
            'Spikecount':         ("Amount of spikes",          3.0,                0.01)
}

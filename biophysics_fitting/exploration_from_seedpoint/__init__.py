...
def evaluation_function_incremental_helper(
    ...
    is above the desired cutoff defined in :py:param:`cutoffs`.
    ...
    Args:
        ...
        cutoffs (dict): Dictionary with keys that are in :py:param:`stim_order`. Values are floats that define a maximum allowed error for any objective corresponding to that stimulus.
        ...
        evaluators_by_stimulus (dict): Dictionary with keys that are in :py:param:`stim_order`. Values are evaluators that are used to evaluate the voltage traces.
        ...
        objectives_by_stimulus (dict): Dictionary with keys that are in :py:param:`stim_order`. Values are lists of objectives that are used to evaluate the voltage traces.

...
class BAC:
    ...
    def BAC_APheight(self, voltage_traces):
        t,v = voltage_traces['tVec'],voltage_traces['vList'][0]
        return {'.check_1AP': nan_if_error(AP_height_check_1AP)(t,v,thresh=self.soma_thresh),
    ...
    def BAC_ISI(self, voltage_traces):
        ...
        return {'.check_2_or_3_APs': nan_if_error(BAC_ISI_check_2_or_3_APs)(t,v,thresh=self.soma_thresh),
                '.check_repolarization': nan_if_error(BAC_ISI_check_repolarization)(t,v,stim_end=stim_end,repolarization=r),
                '.raw': nan_if_error(BAC_ISI)(t,v,thresh=self.soma_thresh)}
    
    def BAC_ahpdepth(self,voltage_traces):
        t,v = voltage_traces['tVec'],voltage_traces['vList'][0]
        return {'.check_2AP': nan_if_error(AHP_depth_abs_check_2AP)(t,v,thresh=self.soma_thresh),
    ...
    def BAC_caSpike_width(self,voltage_traces):
        t,v = voltage_traces['tVec'],voltage_traces['vList'][0]
        v_dend = voltage_traces['vList'][1]
        return {'.check_1_Ca_AP': nan_if_error(BAC_caSpike_width_check_1_Ca_AP)(t,v,v_dend,thresh=self.hot_zone_thresh),
                '.raw':nan_if_error(BAC_caSpike_width)(t,v,v_dend,thresh=self.hot_zone_thresh)}
...
class bAP:
    def __init__(self,
                 ...
                 punish_returning_to_rest_tolerance = 2.,
                 definitions = {'bAP_APheight': ('AP_height', 25.0, 5.0),
    ...
    def bAP_APwidth(self, voltage_traces):
        t,v = voltage_traces['tVec'],voltage_traces['vList'][0]
        return {'.check_1AP': nan_if_error(AP_width_check_1AP)(t,v,thresh=self.soma_thresh),
    ...
    def _bAP_att(self, voltage_traces, _n=1):
        ...
        return {'.raw': nan_if_error(BPAPatt)(t,v_dend,self.bAP_thresh,self.stim_onset),
                '.check_1_AP': nan_if_error(BPAPatt_check_1_AP)(t,v,thresh=self.soma_thresh),
                '.check_relative_height': nan_if_error(BPAPatt_check_relative_height)(t,v,v_dend,
                                                                                      self.bAP_thresh,
                                                                                      self.stim_onset)}

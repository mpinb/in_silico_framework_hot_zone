...
hocFile = I.os.path.join(getting_started_dir, hocDataPath,"504_GP_WR662_cell_1171_PoM_checked_RE.hoc")
hocFileOutput = I.os.path.join(getting_started_dir,outputFolderPath,"504_hocFileWithRad.hoc")

...
# def make_filelist(simresult_path, contains = 'vm_all_traces.csv'):
#     file_list = make_file_list(simresult_path, contains)
#     if len(file_list) == 0:
#         raise ValueError("Did not find any '*vm_all_traces.csv'-files. Filelist empty. Abort initialization.")
#     file_list = sorted(file_list, key = lambda x: os.path.dirname(x))
#     return file_list

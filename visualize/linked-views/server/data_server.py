...
@app.route('/matrixServer/', methods=['GET'])
def get_objects():
    global objects
    return jsonify(objects)

@app.route('/matrixServer/<name>', methods=['DELETE'])
...
@app.route('/matrixServer/', methods=['POST'])
def add_object():
...
def printUsageAndExit():
    print("Usage:")
    print("python data_server.py <data-folder>")
    exit()

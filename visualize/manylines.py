...
def manylines(
    ...
    Args:
        ...
        colormap (dict): a colormap, mapping values for :py:param:groupby_attribute to colors.
    ...
    Returns:
        fig (matplotlib.pyplot.Figure): Figure object containing all lines defined in :py:param:df
    '''

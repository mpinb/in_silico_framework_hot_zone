...
def manylines(
    ...
    Args:
        ...
        colormap (dict): a colormap, mapping values for :param:groupby_attribute to colors.
    ...
    Returns:
        fig (matplotlib.pyplot.Figure): Figure object containing all lines defined in :param:df
    '''

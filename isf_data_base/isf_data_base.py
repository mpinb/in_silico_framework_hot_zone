...
from . import isf_data_base_register
from . import DataBaseException
from .utils import calc_recursive_filetree, rename_for_deletion, delete_in_background, is_db, bcolors
...
def get_dumper_from_folder(folder, return_ = 'module'):
    ...
    if return_ == 'string':
        ...
        return importlib.import_module("isf_data_base.IO.LoaderDumper.{}".format(dumper_string))
...
class DataBase:
    def __init__(self, basedir, readonly = False, nocreate = False):
        ...
        - 'dumper': Which data dumper was used to save this result. 
            ...
            See :module isf_data_base.IO.LoaderDumper: for all dumpers and loaders.
    ...
    def register_dumper(self, dumper_module):
        ...
        Args:
            dumper_module (module): A module from isf_data_base.IO.LoaderDumper. Must contain a Loader class and a dump() method.
    ...
    def get_mkdtemp(self, prefix = '', suffix = ''):
        '''creates a directory in the isf_data_base directory and 
        returns the path'''
    ...
    def create_sub_db(self, key, register = 'as_parent', **kwargs):
        ...
        Kwargs:
            ...
            Other kwargs will be passed to the dumper, and may depend on which dumper you're using. Consult :module isf_data_base.IO.LoaderDumper: for more information on possible kwargs.
    ...
    def __delitem__(self, key):
        """
        Items can be deleted using del my_isf_data_base[key]
    ...
    def remove(self):
        ...
        def delete_and_deregister_once_deleted(dir_to_data, unique_id):
            ...
            register = isf_data_base_register._get_db_register()

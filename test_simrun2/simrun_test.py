...
networkName = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/evoked_activity/model_run1/C2_evoked_UpState_INH_PW_1.0_SuW_0.5_active_ex_timing_C2center.param'
example_path = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/evoked_activity/model_run1/results/control/C2_evoked_UpState_INH_PW_1.0_SuW_0.5_C2center/20150815-1530_20240/simulation_run0000_synapses.csv'
class Tests(unittest.TestCase):       
    ...
    def test_position_of_morphology_does_not_matter_after_network_mapping(self):  
        try:
            ...
            dummy = simrun2.run_existing_synapse_activations.run_existing_synapse_activations(cellParamName, networkName, [example_path], simName='', dirPrefix=dirPrefix, nprocs=1, tStop=345, silent=True)
            dummy = dummy.compute(get = dask.async.get_sync)
            cellParamName_other_position = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/network_embedding/postsynaptic_location/3x3_C2_sampling/B1border/86_CDK_20041214_BAC_run5_soma_Hay2013_B1border_apic_rec.param'
...
#         pass
    ...
    def test_crossing_over_trails_show_identical_response_before_crossing_over_time(self):
        ...
        try:
            ...
            path = os.path.join(os.path.dirname(parent), 'model_data_base', 'test', 'data', 'test_temp')
            mdb = I.ModelDataBase(path)

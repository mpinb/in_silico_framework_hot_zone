...
class Tests:
    ...
    def test_filter_spike_times(self):
        ...
        for spike_times_trough in [[10], [10, 10.1], [10, 10.1, 10.2]]:
            ...
            st, ampl = filter_spike_times([8, 8.1, 8.2],
                                          spike_times_trough,
                                          spike_times_amplitude=sta)
    ...
    def test_stimulus_interval_filter(self):
        ...
        assert stimulus_interval_filter([1, 2, 3, 4], period_length=2,
                                        offset=1) == [2, 4]
    ...
    def test_event_analysis_ISIn(self):
        ...
        tst = _TestSpikeTimes(
            spike_times=st
        )  # init test spike times object with just the spike_times attribute
        ...
        pd.util.testing.assert_frame_equal(pd.DataFrame(expected),
                                           stap.event_analysis_ISIn(st))

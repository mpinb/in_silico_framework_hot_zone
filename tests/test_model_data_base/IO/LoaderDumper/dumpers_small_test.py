...
import dask 
from isf_data_base.IO.LoaderDumper import dask_to_csv, numpy_to_npy, pandas_to_parquet, dask_to_parquet, \
...
def test_self_small(fresh_db, pdf):
    data_frame_generic_small(fresh_db, pdf, pdf.copy(), 'self')

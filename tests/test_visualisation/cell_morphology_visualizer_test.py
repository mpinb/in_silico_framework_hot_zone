...
class TestCellMorphologyVisualizer:
    def setup_class(self):
        ...
        self.cmv.t_start, self.cmv.t_end, self.cmv.t_step = self.t_start, self.t_end, self.t_step
...
class TestCellMorphologyInteractiveVisualizer:
    ...
    def test_has_ion_data(self):
        ...
        assert len(self.cmiv.scalar_data[self.ion_keyword][0]) == len(self.cmiv.morphology) + self.cmiv.n_sections - 1
    ...
    def test_display_interactive_ion_dynamics_in_morphology_3d(self):
        fig = self.cmiv.display_interactive_ion_dynamics_in_morphology_3d(ion_keyword='NaTa_t.ina')
        return 0
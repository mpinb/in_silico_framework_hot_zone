...
import pandas as pd
import dask
from  isf_data_base.IO.LoaderDumper import dask_to_csv, numpy_to_npy, pandas_to_parquet, \
...
def test_dask_to_csv_real_data(fresh_db):
    real_data_generic(db_=fresh_db, dumper_=dask_to_csv, client_=None)

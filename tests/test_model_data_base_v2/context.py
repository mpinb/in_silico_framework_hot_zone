...
class FreshlyInitializedMdb(object):
    ...
    It is recommended to use the pytest fixture fresh_mdb_v2 instead of this class, except when the location of the mdb is of importance. This is the case in tests:

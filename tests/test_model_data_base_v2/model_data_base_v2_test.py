from model_data_base.model_data_base_v2_v2 import ModelDataBase, MdbException
...
def test_metadata_update(empty_mdb_v2):
    ...
    metadata_db_path = os.path.join(empty_mdb_v2.basedir, 'metadata.db')
    assert os.path.exists(metadata_db_path)
    os.remove(os.path.join(empty_mdb_v2.basedir, 'metadata.db'))

    assert empty_mdb_v2.metadata['test']['dumper'] == 'unknown'
    assert empty_mdb_v2.metadata['test2']['dumper'] == 'unknown'

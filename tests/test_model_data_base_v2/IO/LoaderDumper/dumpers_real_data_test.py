...
def test_dask_to_csv_real_data(fresh_mdb_v2):
    real_data_generic(mdb_=fresh_mdb_v2, dumper_=dask_to_csv, client_=None)


def test_dask_to_categorized_msgpack_real_data(client, fresh_mdb_v2):
    real_data_generic(mdb_=fresh_mdb_v2,
                      dumper_=dask_to_categorized_msgpack,
                      client_=client)


def test_dask_to_msgpack_real_data(client, fresh_mdb_v2):
    real_data_generic(mdb_=fresh_mdb_v2, dumper_=dask_to_msgpack, client_=client)

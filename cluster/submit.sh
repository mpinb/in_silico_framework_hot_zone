...
ulimit -Sn "\$(ulimit -Hn)"
srun -n1 -N$nodes -c$cores python -u \$MYBASEDIR/project_src/in_silico_framework/cluster/component_1_SOMA.py \$MYBASEDIR/management_dir_$name $launch_jupyter_server
EoF
)
echo $output
echo "---------------------------------------------"

...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_Tst /nas1/Data_arco/project_src/in_silico_framework/mechanisms/channels/K_Tst.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/nas1/Data_arco/project_src/in_silico_framework/mechanisms/channels/K_Tst.mod";
static const char* nmodl_file_text = 

...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 gaba_syn_old /nas1/Data_arco/project_src/in_silico_framework/mechanisms/channels/x86_64/netgaba_old.mod\n");
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t; {
   state_discontinuity ( _cvode_ieq + 0, & R , R + factor * _args[0] * dgaba * fgaba ) ;
   state_discontinuity ( _cvode_ieq + 1, & D , D + factor * _args[0] * dgaba * fgaba ) ;
   state_discontinuity ( _cvode_ieq + 2, & dgaba , dgaba * decaygaba ) ;
   state_discontinuity ( _cvode_ieq + 3, & fgaba , fgaba + facilgaba ) ;
   } }
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 59 in file netgaba_old.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}

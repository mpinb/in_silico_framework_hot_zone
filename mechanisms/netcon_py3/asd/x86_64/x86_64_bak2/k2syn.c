...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 K2Syn /nas1/Data_arco/project_src/in_silico_framework/mechanisms/netcon/k2syn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/nas1/Data_arco/project_src/in_silico_framework/mechanisms/netcon/k2syn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"

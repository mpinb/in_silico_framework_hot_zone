...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GSyn /nas1/Data_arco/project_src/in_silico_framework/mechanisms/netcon_py3/gsyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/nas1/Data_arco/project_src/in_silico_framework/mechanisms/netcon_py3/gsyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"

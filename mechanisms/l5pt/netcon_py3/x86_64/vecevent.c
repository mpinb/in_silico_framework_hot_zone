...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 VecStim /gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/netcon_py3/vecevent.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/netcon_py3/vecevent.mod";
static const char* nmodl_file_text = 

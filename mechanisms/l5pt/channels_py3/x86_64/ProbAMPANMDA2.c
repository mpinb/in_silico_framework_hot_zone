...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2 /gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py3/ProbAMPANMDA2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py3/ProbAMPANMDA2.mod";
static const char* nmodl_file_text = 

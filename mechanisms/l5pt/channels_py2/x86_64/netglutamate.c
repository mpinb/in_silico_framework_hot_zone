...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 glutamate_syn /gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py2/x86_64/netglutamate.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py2/netglutamate.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "//****************************//\n"

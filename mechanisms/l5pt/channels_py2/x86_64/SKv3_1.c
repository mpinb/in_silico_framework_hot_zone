...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 SKv3_1 /gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py2/x86_64/SKv3_1.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/gpfs/soma_fs/scratch/meulemeester/project_src/in_silico_framework/mechanisms/channels_py2/SKv3_1.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"

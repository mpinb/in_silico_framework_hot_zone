...
extern void _CaDynamics_E2_v2_reg(void);
...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," netgaba_old.mod");
    fprintf(stderr," netglutamate.mod");
    fprintf(stderr," netglutamate_old.mod");

...
def skip_time(df, t_skip_start, t_skip_end):
    ...
    x = merge_synapse_activation(df_pre_skip.reset_index(), df_post_skip.reset_index())
    return x
...
def skip_time_and_save_parallel(synapse_activation_db, sim_trail_index_list, t_skip_start, t_skip_end, dirPrefix):

...
class Model(torch.nn.Module):
    def __init__(self, 
                 ...
                 total_variation_spatial = None,
                 total_variation_temporal = None,
                 L2_hypernetwork = None,
                 neighbors_0 = None,
                 neighbors_1 = None):
        ...
        self.linear1 = nn.Linear(in_features = n_celltypes*temporal_window_width*n_spatial_bins + bottleneck_ISI_soma + bottleneck_ISI_dend + n_parameters, 
    ...
    def forward(self,X_ISI_MCM_list):
        ...
        torch.cat([X,ISI_SOMA,ISI_DEND,BIOPHYSICS])
        ...
        bottleneck_values = self.linear1.forward(X) # (X * weights).sum(dim=1, keepdim=True)

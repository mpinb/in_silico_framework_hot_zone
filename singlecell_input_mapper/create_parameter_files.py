...
#                'C3border','D1border','D2border','D3border']
#cellLocations = ['C2center']

pythonScriptName = '~/project_src/NeuroSim/functional_network_assembly/evoked_network_param_from_template.py'
...
#synParamName = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/ongoing_activity/ongoing_activity_celltype_template_exc_conductances_fitted_NMDA_decay65.0_amp0.6.param'
synParamName = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/ongoing_activity/ongoing_activity_celltype_template_exc_conductances_fitted.param'
...
outPath = '/nas1/Data_regger/AXON_SAGA/Axon4/PassiveTouch/L5tt/evoked_activity/model_run1/'
